              ...
              <table className="ptable">
                ...
                <tbody>
                  ...
                  {[
                    ...
                    { label: 'Est. Junction Temp Tj [°C]', formula: `Tamb + P_dev×(RthJC+RthCS+RthSA[${project.system_specs.cooling || 'natural'}])`, key: 't_junc', lowerBetter: true, cls: 'rgba(255,171,0,0.10)' },
