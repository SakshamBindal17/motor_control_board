...
const SECTIONS = [
  ...
  },
  {
    ...
    rows: [
      ...
      { key: 'coss_loss_per_fet_w', label: 'Coss Loss / FET', unit: 'W', dec: 3, explain: 'Definition: Output capacitance loss. Formula: 0.5 × Qoss × V_bus × fsw. Energy stored at turn-off is dissipated at turn-on.' },
      { key: 'qoss_loss_per_fet_w', label: 'Qoss Loss / FET', unit: 'W', dec: 3, explain: 'Definition: Total Qoss loss per switch. Formula: Qoss × V_bus × fsw.' },
      { key: 'total_loss_per_fet_w', label: 'Total / FET', unit: 'W', dec: 3, warn: 8, danger: 15, explain: 'Definition: Sum of Conduction, Switching, Recovery, Gate Charge, Coss, Qoss, and Body Diode losses for a single MOSFET wrapper.' },
